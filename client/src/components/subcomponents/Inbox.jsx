...
export default function Inbox({person,lastmessage,lastsender,count_message,time}) {
  return (
    <>
        <div className="w-[690px] h-[128px] flex justify-between items-center border-b-2 border-b-[#2FBCE8] hover:bg-[#2FBCE8] hover:bg-opacity-40 auto-rows-auto cursor-pointer">
